...
class Communication {
  ...
  String get hostname {
    ...
    //return "${DataModel.protokollBezeichner}://${DataModel.fileServer}";
    return "http://h2834086.stratoserver.net:8080";
    if (useMedSrv) {
      return 'http://medsrv.informatik.hs-fulda.de:80';
  ...
  Future<String> makeGetRequest(String url, String path) async {
    // make GET request
    Response response = await get(url + path);
  ...
  Future<String> listAllWunschliste() async {
    String result =
        await makeGetRequest(hostname, "/rest/wunschliste/list/all");
    return result;
  }

  Future<String> listAcceptedWunschliste() async {
    String result =
        await makeGetRequest(hostname, "/rest/wunschliste/list/accepted");
    return result;
  }

  Future<String> listRequestedWunschliste() async {
    String result =
        await makeGetRequest(hostname, "/rest/wunschliste/list/requested");
    return result;
  }

  Future<String> listWunschlisteByUdid(String udid) async {
    String result =
        await makeGetRequest(hostname, "/rest/wunschliste/list/udid/${udid}");
    return result;
  }

  Future<String> acceptWunschliste(String id) async {
    String result =
        await makeGetRequest(hostname, "/rest/wunschliste/accept/${id}");
    return result;
  }

  Future<String> deleteWunschliste(String id) async {
    String result =
        await makeGetRequest(hostname, "/rest/wunschliste/delete/${id}");
    return result;
  }

  Future<String> addWunschliste(
      String udid, String start, String content) async {
    String result = await makeGetRequest(
        hostname, "/rest/wunschliste/add/${udid}/${start}/${content}");
    return result;
  }
...
// /rest/message/add/:udid/:status/:content -> fügt neue Nachricht hinzu
  ...
  Future<String> listAllMessages() async {
    String result = await makeGetRequest(hostname, "/rest/message/list/all");
    return result;
  }

  Future<String> listMessageDistinctUdid() async {
    String result =
        await makeGetRequest(hostname, "/rest/message/list/distinct/udid");
    return result;
  }

  Future<String> listLastNMessages(int number) async {
    String result =
        await makeGetRequest(hostname, "/rest/message/list/last/${number}");
    return result;
  }

  Future<String> listLastNMessagesByUdid(String udid, int number) async {
    String result = await makeGetRequest(
        hostname, "/rest/message/list/last/udid/${udid}/${number}");
    return result;
  }

  Future<String> deleteMessageById(int id) async {
    String result =
        await makeGetRequest(hostname, "/rest/message/delete/${id}");
    return result;
  }

  Future<String> deleteLastNMessages(int number) async {
    String result =
        await makeGetRequest(hostname, "/rest/message/delete/last/${number}");
    return result;
  }
  ...
  Future<String> markMessagesOldByUdid(String udid) async {
    String result =
        await makeGetRequest(hostname, "/rest/message/mark/old/${udid}");
    return result;
  }

  Future<String> addMessage(String udid, String status, String content) async {
    String result = await makeGetRequest(
        hostname, "/rest/message/add/${udid}/${status}/${content}");
    return result;
  }
  ...
  Future<String> listAllNews() async {
    String result = await makeGetRequest(hostname, "/rest/news/list/all");
    return result;
  }

  Future<String> addNews(String udid, String content) async {
    String result =
        await makeGetRequest(hostname, "/rest/news/add/${udid}/${content}");
    return result;
  }

  Future<String> deleteNewsById(int id) async {
    String result = await makeGetRequest(hostname, "/rest/news/delete/${id}");
    return result;
  }
  ...
  Future<String> listAllNewThings() async {
    String result = await makeGetRequest(hostname, "/rest/newthing/list/all");
    return result;
  }

  Future<String> addNewThing(String udid, String content) async {
    String result =
        await makeGetRequest(hostname, "/rest/newthing/add/${udid}/${content}");
    return result;
  }

  Future<String> deleteNewThingById(int id) async {
    String result =
        await makeGetRequest(hostname, "/rest/newthing/delete/${id}");
    return result;
  }
  ...
  Future<String> listAllWunsch() async {
    String result = await makeGetRequest(hostname, "/rest/wunsch/list/all");
    return result;
  }

  Future<String> addWunsch(String udid, String content) async {
    String result =
        await makeGetRequest(hostname, "/rest/wunsch/add/${udid}/${content}");
    return result;
  }

  Future<String> deleteWunschById(int id) async {
    String result = await makeGetRequest(hostname, "/rest/wunsch/delete/${id}");
    return result;
  }
  ...
  Future<String> adminList() async {
    String result = await makeGetRequest(hostname, "/rest/admin/list");
    return result;
  }

  //r.Get("/rest/admin/list/all", http.HandlerFunc(getAllLeihladen))
  Future<String> adminListAll() async {
    String result = await makeGetRequest(hostname, "/rest/admin/list/all");
    return result;
  }
  ...
  Future<String> adminListDistinctUdid() async {
    String result =
        await makeGetRequest(hostname, "/rest/admin/list/distinct/udid");
    return result;
  }

  //r.Get("/rest/admin/reset", http.HandlerFunc(resetLeihladen))
  Future<String> adminReset() async {
    String result = await makeGetRequest(hostname, "/rest/admin/reset");
    return result;
  }
  ...
  Future<String> adminListUdid(String udid) async {
    String result =
        await makeGetRequest(hostname, "/rest/admin/list/udid/${udid}");
    return result;
  }
  ...
  Future<String> adminListStatus(String status) async {
    String result =
        await makeGetRequest(hostname, "/rest/admin/list/status/${status}");
    return result;
  }
...
//r.Get("/rest/admin/delete/id/:id", http.HandlerFunc(deleteLeihladenById))
  ...
  Future<String> adminDeleteId(String id) async {
    String result =
        await makeGetRequest(hostname, "/rest/admin/delete/id/${id}");
    return result;
  }
...
//r.Get("/rest/admin/add/status/:udid/:status", http.HandlerFunc(addLeihladenByStatus))
  ...
  Future<String> adminAddStatus(String udid, String status) async {
    String result = await makeGetRequest(
        hostname, "/rest/admin/add/status/${udid}/${status}");
    return result;
  }
...
//r.Get("/rest/admin/update/:id/:inventarnummer/:status/:ext/:start/:ende/:udid", http.HandlerFunc(updateDBEntry))
  ...
  Future<String> adminUpdate(String id, String inventarnummer, String status,
    ...
    String result = await makeGetRequest(hostname,
...
//r.Get("/rest/admin/setStatus/reserviert/:id", http.HandlerFunc(setStatusReserviertByID))
  ...
  Future<String> adminReserviertId(String id) async {
    String result = await makeGetRequest(
        hostname, "/rest/admin/setStatus/reserviert/${id}");
    return result;
  }
...
//r.Get("/rest/admin/setStatus/verliehen/:id", http.HandlerFunc(setStatusVerliehenByID))
  ...
  Future<String> adminVerliehenId(String id) async {
    String result =
        await makeGetRequest(hostname, "/rest/admin/setStatus/verliehen/${id}");
    return result;
  }
...
//r.Get("/rest/admin/setStatus/defekt/:id", http.HandlerFunc(setStatusDefektByID))
  ...
  Future<String> adminDefektId(String id) async {
    String result =
        await makeGetRequest(hostname, "/rest/admin/setStatus/defekt/${id}");
    return result;
  }
...
//r.Get("/rest/admin/setStatus/verloren/:id", http.HandlerFunc(setStatusVerlorenByID))
  ...
  Future<String> adminVerlorenId(String id) async {
    String result =
        await makeGetRequest(hostname, "/rest/admin/setStatus/verloren/${id}");
    return result;
  }
...
//r.Get("/rest/admin/setExtension/:id/:value", http.HandlerFunc(setExtensionByID))
  ...
  Future<String> adminSetExtension(String id, String value) async {
    String result = await makeGetRequest(
        hostname, "/rest/admin/setExtension/${id}/${value}");
    return result;
  }
  ...
  Future<String> reservierungListAll() async {
    String result =
        await makeGetRequest(hostname, "/rest/reservierung/list/all");
    return result;
  }
  ...
  Future<String> reservierungListAllDate(String date) async {
    String result = await makeGetRequest(
        hostname, "/rest/reservierung/list/all/date/${date}");
    return result;
  }
  ...
  Future<String> reservierungListUdidDate(String udid, String date) async {
    String result = await makeGetRequest(
        hostname, "/rest/reservierung/list/date/${udid}/${date}");
    return result;
  }
  ...
  Future<String> reservierungListInterval(String start, String ende) async {
    String result = await makeGetRequest(
        hostname, "/rest/reservierung/list/all/interval/${start}/${ende}");
    return result;
  }
  ...
  Future<String> reservierungListUdid(String udid) async {
    String result =
        await makeGetRequest(hostname, "/rest/reservierung/list/${udid}");
    return result;
  }
  ...
  Future<String> reservierungDeleteUdid(String udid) async {
    String result =
        await makeGetRequest(hostname, "/rest/reservierung/delete/${udid}");
    return result;
  }
  ...
  Future<String> reservierungDeleteInventarnummer(String inventarnummer) async {
    String result = await makeGetRequest(
        hostname, "/rest/reservierung/delete/inventarnummer/${inventarnummer}");
    return result;
  }
  ...
  Future<String> reservierungDeleteId(int id) async {
    String result =
        await makeGetRequest(hostname, "/rest/reservierung/delete/id/${id}");
    return result;
  }
...
//r.Get("/rest/reservierung/add/:udid/:inventarnummer/:start/:ende", http.HandlerFunc(addReservierung))
  ...
  Future<String> belegtListAll() async {
    String result = await makeGetRequest(hostname, "/rest/belegt/list/all");
    return result;
  }
  ...
  Future<String> belegtListAllDate(String date) async {
    String result =
        await makeGetRequest(hostname, "/rest/belegt/list/all/date/${date}");
    return result;
  }
  ...
  Future<String> belegtListUdidDate(String udid, String date) async {
    String result = await makeGetRequest(
        hostname, "/rest/belegt/list/date/${udid}/${date}");
    return result;
  }
  ...
  Future<String> belegtListInterval(String start, String ende) async {
    String result = await makeGetRequest(
        hostname, "/rest/belegt/list/all/interval/${start}/${ende}");
    return result;
  }
  ...
  Future<String> verliehenListAll() async {
    String result = await makeGetRequest(hostname, "/rest/verliehen/list/all");
    return result;
  }
  ...
  Future<String> verliehenListUdid(String udid) async {
    String result =
        await makeGetRequest(hostname, "/rest/verliehen/list/udid/${udid}");
    return result;
  }
  ...
  Future<String> verliehenListAllDate(String date) async {
    String result =
        await makeGetRequest(hostname, "/rest/verliehen/list/all/date/${date}");
    return result;
  }
...
//r.Get("/rest/admin/setExtension/:id/:value", http.HandlerFunc(setExtensionByID))
  ...
  Future<bool> adminIsAdminByUdid(String udid) async {
    String answer =
        await makeGetRequest(hostname, "/rest/admin/isAdmin/${udid}");
  ...
  Future<String> uploadImage(File file, String fname) async {
    var request =
        MultipartRequest('POST', Uri.parse(hostname + "/upload/upload"));
    request.files.add(
  ...
  Future<String> recreateCatalog(String dataDir) async {
    var request = MultipartRequest(
        'POST', Uri.parse(hostname + "/rest/admin/catalog/recreate"));
